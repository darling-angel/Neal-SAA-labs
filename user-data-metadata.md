...
Example commmands to run:
    ...
    Get the instance ID: curl http://169.254.169.254/latest/meta-data/instance-id

    Get the AMI ID: curl http://169.254.169.254/latest/meta-data/ami-id

    Get the instance type: curl http://169.254.169.254/latest/meta-data/instance-type

    Get the local IPv4 address: curl http://169.254.169.254/latest/meta-data/local-ipv4

    Get the public IPv4 address: curl http://169.254.169.254/latest/meta-data/public-ipv4
